...
// MARK: - InterruptionAudioService
open class InterruptionAudioServiceMock: InterruptionAudioService, Mock {
    init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    public var onInterruptionBegan: (() -> Void)? {
		get {	invocations.append(.p_onInterruptionBegan_get); return __p_onInterruptionBegan ?? optionalGivenGetterValue(.p_onInterruptionBegan_get, "InterruptionAudioServiceMock - stub value for onInterruptionBegan was not defined") }
		set {	invocations.append(.p_onInterruptionBegan_set(.value(newValue))); __p_onInterruptionBegan = newValue }
	}
	private var __p_onInterruptionBegan: (() -> Void)?

    public var onInterruptionEnded: (() -> Void)? {
		get {	invocations.append(.p_onInterruptionEnded_get); return __p_onInterruptionEnded ?? optionalGivenGetterValue(.p_onInterruptionEnded_get, "InterruptionAudioServiceMock - stub value for onInterruptionEnded was not defined") }
		set {	invocations.append(.p_onInterruptionEnded_set(.value(newValue))); __p_onInterruptionEnded = newValue }
	}
	private var __p_onInterruptionEnded: (() -> Void)?
    ...
    fileprivate enum MethodType {
        case p_onInterruptionBegan_get
		case p_onInterruptionBegan_set(Parameter<(() -> Void)?>)
        case p_onInterruptionEnded_get
		case p_onInterruptionEnded_set(Parameter<(() -> Void)?>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case (.p_onInterruptionBegan_get,.p_onInterruptionBegan_get): return true
			case (.p_onInterruptionBegan_set(let left),.p_onInterruptionBegan_set(let right)): return Parameter<(() -> Void)?>.compare(lhs: left, rhs: right, with: matcher)
            case (.p_onInterruptionEnded_get,.p_onInterruptionEnded_get): return true
			case (.p_onInterruptionEnded_set(let left),.p_onInterruptionEnded_set(let right)): return Parameter<(() -> Void)?>.compare(lhs: left, rhs: right, with: matcher)
            default: return false
            }
        }
        ...
        func intValue() -> Int {
            switch self {
            case .p_onInterruptionBegan_get: return 0
			case .p_onInterruptionBegan_set(let newValue): return newValue.intValue
            case .p_onInterruptionEnded_get: return 0
			case .p_onInterruptionEnded_set(let newValue): return newValue.intValue
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func onInterruptionBegan(getter defaultValue: (() -> Void)?...) -> PropertyStub {
            return Given(method: .p_onInterruptionBegan_get, products: defaultValue.map({ StubProduct.return($0 as Any) }))
        }
        public static func onInterruptionEnded(getter defaultValue: (() -> Void)?...) -> PropertyStub {
            return Given(method: .p_onInterruptionEnded_get, products: defaultValue.map({ StubProduct.return($0 as Any) }))
        }
    ...
    public struct Verify {
        ...
        public static var onInterruptionBegan: Verify { return Verify(method: .p_onInterruptionBegan_get) }
		public static func onInterruptionBegan(set newValue: Parameter<(() -> Void)?>) -> Verify { return Verify(method: .p_onInterruptionBegan_set(newValue)) }
        public static var onInterruptionEnded: Verify { return Verify(method: .p_onInterruptionEnded_get) }
		public static func onInterruptionEnded(set newValue: Parameter<(() -> Void)?>) -> Verify { return Verify(method: .p_onInterruptionEnded_set(newValue)) }
    }
